...
COPY name_basics
FROM '/datasets.imdbws.com/name.basics.tsv.gz'
-- Is the below the way to gunzip a gzipped file?
'gunzip -p'
DELIMITER E'\t'
CSV HEADER;
...
COPY title_basics
FROM '/datasets.imdbws.com/title.basics.tsv.gz'
'gunzip -p'
DELIMITER E'\t'
CSV HEADER;
...
COPY title_ratings
FROM '/datasets.imdbws.com/title.ratings.tsv.gz'
'gunzip -p'
DELIMITER E'\t'
CSV HEADER;
...
FROM '/datasets.imdbws.com/title.principals.tsv.gz'
'gunzip -p'
DELIMITER E'\t'
CSV HEADER;
...
COPY title_crew
FROM '/datasets.imdbws.com/title.crew.tsv.gz'
'gunzip -p'
DELIMITER E'\t'
CSV HEADER;
